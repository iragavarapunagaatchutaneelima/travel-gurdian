...
def get_active_checkin(user_id: str = "default_user", db: Session = Depends(get_db)):
    """
...
def cancel_checkin(user_id: str = "default_user", db: Session = Depends(get_db)):
    """
...
def update_checkin_gps(location: schemas.SafeCheckInLocationUpdate, user_id: str = "default_user", db: Session = Depends(get_db)):
    """
